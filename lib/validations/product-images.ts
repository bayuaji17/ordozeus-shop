...
export const uploadImagesSchema = z.object({
  ...
  files: z
    ...
    .max(MAX_IMAGES_PER_PRODUCT, `Maximum ${MAX_IMAGES_PER_PRODUCT} images allowed`),
});
...
export type UpdateImageAltTextFormData = z.infer<typeof updateImageAltTextSchema>;
